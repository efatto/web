...
instance.web.ListView = instance.web.View.extend( /** @lends instance.web.ListView# */ {
            ...
            this.$pager
                .on('click', 'a[data-pager-action]', function () {
                    ...
                    .click(function (e) {
                        ...
                        if(!instance.web.ListView.prototype.pager_options) {
                            instance.web.ListView.prototype.pager_options =
                        ...
                        var $select = $('<select>')
                            ...
                            .append(instance.web.ListView.prototype.pager_options)
                            .change(function () {
    ...
    configure_pager: function (dataset) {
        // 20141129 - FIX this.$pager not found error
        if(!this.$pager)
            return '';
    ...
    do_delete: function (ids) {
        ...
        if (!this.options.no_confirm && !confirm(_t("Do you really want to remove these records?"))) {
            return;
        }
        var self = this;
        ...
        if(column.type === 'reference') {
            ...
            if (value instanceof Array && !_.isEmpty(value)
                ...
                new instance.web.Model(column.relation)
                    .call('name_get', [ids], {'context': this.session.user_context}).done(function (names) {
